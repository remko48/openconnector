...
class CallService
{
    ...
    public function call(
        ...
        $method = $this->decideMethod(default: $method, configuration: $config, read: $read);
            ...
            // $createCertificates && $this->getCertificate($config);        // Make sure to filter out all the authentication variables / secrets.
            $config = array_filter(
                $config,
                function ($key) {
     ...
     *
     * @return array<string,mixed> The resulting object
     *
     * @throws GuzzleException
     * @throws Exception
     */
