...
class AuthenticationService
{
    ...
    private function createClientCredentialConfig(array $configuration): array
    {
        ...
        // @todo: check for off-cases, i.e. camelCase (not according to OAuth standards)     if (isset($configuration['client_assertion_type']) === true && $configuration['client_assertion_type'] === 'urn:ietf:params:oauth:client-assertion-type:jwt-bearer') {
