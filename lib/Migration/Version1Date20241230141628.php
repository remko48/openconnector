...
/**
 * Migration for openconnector_endpoints table modifications.
 *
 * This migration alters the openconnector_endpoints table structure.
 *
 * @package     OpenConnector
 * @category    Migration
 * @author      Conduction Development Team <dev@conduction.nl>
...
class Version1Date20241230141628 extends SimpleMigrationStep
{
     ...
     *
     * Modifies the openconnector_endpoints table structure.
     *
     * @param  IOutput                   $output        Output handler for the migration
     * @param  Closure(): ISchemaWrapper $schemaClosure Closure that returns a schema wrapper
     * @param  array                     $options       Options for the migration
