...
/**
 * Migration for openconnector_synchronization_contract_logs table modifications.
 *
 * This migration alters the openconnector_synchronization_contract_logs table structure.
 *
 * @package     OpenConnector
 * @category    Migration
 * @author      Conduction Development Team <dev@conduction.nl>
...
class Version1Date20241210120155 extends SimpleMigrationStep
{
     ...
     *
     * Modifies the openconnector_synchronization_contract_logs table structure.
     *
     * @param  IOutput                   $output        Output handler for the migration
     * @param  Closure(): ISchemaWrapper $schemaClosure Closure that returns a schema wrapper
     * @param  array                     $options       Options for the migration
